...
INPUT_FILE_PATH = "./post_processing/Unicef_pentaho_output.csv"
OUTPUT_FILE_PATH = "../../output/Unicef/Unicef_FINAL_OUTPUT.csv"
...
df.to_csv(os.path.join(os.path.dirname(__file__), OUTPUT_FILE_PATH), index=False, compression = 'gzip')
